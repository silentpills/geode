...
class WidgetManager:
    ...
    def create_field_selector(
        ...
        self._field_selector_ax = self.fig.add_axes(
            [0.01, start_y, 0.13, total_height], facecolor="lightgoldenrodyellow"
        )

        # Create radio buttons
        self._field_selector = RadioButtons(
            self._field_selector_ax, field_names, active=initial_index
        )
    ...
    def create_reset_button(self, callback: Callable[[], None]) -> Button:
        """
