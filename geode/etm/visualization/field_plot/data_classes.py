...
class PlotState:
    ...
    quivers_grid: List[Optional[object]] = field(
        default_factory=lambda: [None, None, None]
    )
    quivers_stn: List[Optional[object]] = field(
        default_factory=lambda: [None, None, None]
    )
    quiver_keys: List[Optional[object]] = field(
        default_factory=lambda: [None, None, None]
    )
    colorbars: List[Optional[object]] = field(
        default_factory=lambda: [None, None, None]
    )
    ellipses: List[List[object]] = field(default_factory=lambda: [[], [], []])
    scatter_artists: List[Optional[object]] = field(
        default_factory=lambda: [None, None, None]
    )
    contour_lines: List[Optional[object]] = field(
        default_factory=lambda: [None, None, None]
    )
    contour_labels: List[List[object]] = field(default_factory=lambda: [[], [], []])

    # View states for each subplot
    view_states: List[ViewState] = field(
        default_factory=lambda: [ViewState(), ViewState(), ViewState()]
    )
