...
from geode.etm.core.type_declarations import PeriodicStatus, SolutionType
...
type_dict_user = {0: "MECHANICAL", 1: "CO+POSTSEISMIC", 2: "POSTSEISMIC"}
...
class EtmParams:
    ...
    @classmethod
    def from_etm(
        cls, etm: "EtmEngine", cnn: Optional[dbConnection.Cnn] = None
    ) -> "EtmParams":
        """
    ...
    def push_params(
        ...
        copy_params: Optional[bool] = None,
    ) -> None:
        """
    ...
    def _delete_params(
        self,
        object_type: str,
        soln: Optional[str] = None,
        respect_copy_params: bool = True,
    ) -> None:
    ...
    def _handle_copy_params(self, copy_params: bool) -> None:
        ...
        if copy_params:
            ...
            for soln in SolutionType:
                if (
                    soln.code != self.solution_code
                    and soln.code != SolutionType.DRA.code
                ):
