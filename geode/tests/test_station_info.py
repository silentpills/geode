...
class TestStationInfoRecordParsing:
    ...
    def test_parse_all_records_with_daz(self):
        ...
        records = [
            StationInfoRecord.from_string(line) for line in self.STN_LIST_WITH_DAZ
        ]
    ...
    def test_parse_invalid_record(self):
        ...
        assert (
            StationInfoRecord.from_string("X" * 100) is None
...
class TestStationInfoRecordCreation:
    ...
    def test_record_with_string_init(self):
        ...
        stn_str = (
            " IGM1  Ciudad Autonoma   2003 200  0  0  0  2006 276 11  0  0   0.0000  DHARP   "
    ...
    def test_to_json(self):
        ...
        record = StationInfoRecord(
            NetworkCode="TEST", StationCode="TST1", AntennaHeight=1.5
        )
