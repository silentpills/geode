...
\restrict Zot5bNYrvMs94fLUzgQqVtkXVvjE9OLJCMKL9fzQcyoREdshKOKYeYg3c2LaAx4
...
-- NOTE: This constraint references api_country which is created by Django migrations.
-- The constraint will be added by Django migration after api_country table exists.
--
...
-- Antenna/radome catalog (also applied by Django and processing migrations).
BEGIN;
